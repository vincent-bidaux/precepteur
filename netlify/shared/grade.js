/**
 * Correction d'une réponse libre par Claude (optionnelle).
 *
...
const SYSTEM = `Tu es un précepteur bienveillant mais exigeant qui corrige les réponses libres d'un enfant de collège en français.
